package com.github.maoxp.core.http;
 ...
 * <p>抽象 Http 代理类</p>
 * <p>默认 Http 客户端，是使用 HuTool 中的 Http 客户端工具类 HttpUtil 来实现，此模块基于JDK 的 HttpUrlConnection 封装完成</p>
 *
 * @author mxp
 * @date 2023/6/20年06月20日 09:03
 * @since JDK 1.8
 */
public abstract class AbstractHttpDelegate {
     ...
     */
    public JPayHttpResponse get(String url, Map<String, Object> paramMap, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse post(String url, Map<String, Object> paramMap, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse post(String url, String data, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse patch(String url, Map<String, Object> paramMap, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse patch(String url, String data, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse delete(String url, Map<String, Object> paramMap, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse delete(String url, String data, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse put(String url, Map<String, Object> paramMap, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
     ...
     * @return {@link JPayHttpResponse}  请求返回的结果
     */
    public JPayHttpResponse put(String url, String data, Map<String, String> headers) {
        JPayHttpResponse response = new JPayHttpResponse();
