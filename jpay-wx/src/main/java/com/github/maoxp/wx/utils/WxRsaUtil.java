...
//    /**
//     * V3 公钥加密
//     * <p>微信敏感信息，使用微信支付平台证书中的公钥加密</p>
//     *
//     * @param data      需要加密的数据
//     * @param publicKeyStr 公钥（微信支付平台证书）
//     * @return 加密后的数据
//     * @throws Exception 异常信息
//     */
//    public static String encryptByPublicKeyByWx(String data, String publicKeyStr) throws Exception {
//        return encryptByPublicKey(data, publicKeyStr, "RSA/ECB/OAEPWITHSHA-1ANDMGF1PADDING");
//    }
//
//
//    /**
...
//     * @throws Exception 异常信息
//     */
//    public static String decryptByPrivateKey(String ciphertext, String privateKey, String fillMode) throws Exception {
...
//    }
     ...
     * @throws Exception 异常信息
     */
    public static String signByPrivateKey(String data, String privateKeyString) throws Exception {
        PKCS8EncodedKeySpec priPkcs8 = new PKCS8EncodedKeySpec(Base64.decode(privateKeyString));
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
        PrivateKey priKey = keyFactory.generatePrivate(priPkcs8);

        return signByPrivateKey(data, priKey);
    }
    ...
    public static String signByPrivateKey(String data, PrivateKey privateKey) throws Exception {
        ...
        try {
            ...
            log.error("私钥签名exception: {}", e.getMessage());
            throw e;
        }
    }
     ...
     * @throws Exception 异常信息
     */
    public static boolean checkSignByPublicKey(String data, String sign, String publicKey) throws Exception {
        byte[] encodedKey = Base64.decode(publicKey);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
        PublicKey pubKey = keyFactory.generatePublic(new X509EncodedKeySpec(encodedKey));

        return checkSignByPublicKey(data, sign, pubKey);
    }
     ...
     * @throws Exception 异常信息
     */
    public static boolean checkSignByPublicKey(String data, String sign, PublicKey publicKey) throws Exception {
        // 对 Wechatpay-Signature的字段值 sign 使用Base64进行解码，得到应答签名
        final byte[] decodeSignature = Base64.decode(sign.getBytes(StandardCharsets.UTF_8));
        // 公钥方式，验证应答签名
...
//        System.out.println(checkSignByPublicKey(content, sign, publicKey));
//    }
}
